...
public struct ReviewCopyTool: Tool, Sendable {
    ...
    public let description = """
        Review the site's written copy for clarity, tone, calls to action, and jargon. Pass a \
        route (like '/about') for one page, or omit it to review the site. If the user gives you \
        a route, call this directly with it — do not search for the page first; this tool reads \
        pages from disk and will find them even if a prior search came back empty.
        """
