...
extension AppIntentsTests {
    ...
    struct AnglesiteShortcutsTests {
        @Test("provider exposes deploy/backup/audit + content + edit shortcuts (Open + integrations omitted)")
        func providerListsAllSiriIntents() {
            ...
            // = 9. AppShortcutsProvider caps curated phrases at 10; the Bucket 3 integration
            ...
            #expect(AnglesiteShortcuts.appShortcuts.count == 9)
        }
    }
}
